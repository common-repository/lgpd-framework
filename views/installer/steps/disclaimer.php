...
<p class="lgpd-disclaimer">
	...
	In addition to this, you will need to audit all your processing activities for achieving compliance to LGPD.
	Compliance to LGPD is risk based ongoing process.
	We are here to get you started.
</p>
<hr>
<input type="submit" class="button button-lgpd button-large button-lgpd-large button-center" value="<?php echo _x( 'I accept', '(Admin)', 'lgpd-framework' ); ?>" />
