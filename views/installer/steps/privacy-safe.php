...
<hr>
<p class="lgpd-disclaimer">
	<img src="<?php echo lgpd('config')->get('plugin.url');?>src/Components/PrivacySafe/Privacy-Safe-Brand.png"
		style="float:right;margin:15px;" />
	<p>Strengthen your reputation. The privacy safe seal assures your customers that your business is in compliance with
		privacy laws and regulations. The privacy safe seal will verify that the LGPD Framework plugin is installed.</p>
	...
	<p><label for="lgpd_privacy_safe_params">Seal Code</label>
	<input type='text' name='lgpd_privacy_safe_params'
			placeholder='' value=''></p>
	<p><label for="lgpd_privacy_safe_params">Image Code</label>
	<input type='text' name='lgpd_privacy_safe_imagecode' 
			placeholder='' value=''></p> 
