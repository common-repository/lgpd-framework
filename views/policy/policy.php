...
<ol>
	<li><a href="#lgpd-definitions">Definitions used in this Policy</a></li>
	<li><a href="#lgpd-principles">Data protection principles we follow</a></li>
	<li><a href="#lgpd-rights">What rights do you have regarding your Personal Data</a></li>
	<li><a href="#lgpd-information">What Personal Data we gather about you</a></li>
	<li><a href="#lgpd-processing">How we use your Personal Data</a></li>
	<li><a href="#lgpd-sharing">Who else has access to your Personal Data</a></li>
	<li><a href="#lgpd-security">How we secure your data</a></li>
	<li><a href="#lgpd-cookies">Information about cookies</a></li>
	<li><a href="#lgpd-contact">Contact information</a></li>
</ol>


<h3 id="lgpd-definitions">Definitions</h3>
<p>
...
<h3 id="lgpd-principles">Data Protection Principles</h3>
<p>
...
<h3 id="lgpd-rights">Data Subject's rights</h3>
<p>
...
<ol>
	...
	<li>Right for the help of <a href="#lgpd-contact">supervisory authority</a> – meaning you have the right for the help of a supervisory authority and the right for other legal remedies such as claiming damages.</li>
	<li>Right to withdraw consent – you have the right withdraw any given consent for Processing of your Personal Data.</li>
</ol>


<h3 id="lgpd-information">Data we gather</h3>
<p>
...
<p>
	...
	We gather information from our trusted partners with confirmation that they have legal grounds to share that information with us. This is either information you have provided them directly with or that they have gathered about you on other legal grounds. See the list of our partners <a href="#lgpd-sharing">here</a>.
</p>
...
<h3 id="lgpd-processing">How we use your Personal Data</h3>
...
<h3 id="lgpd-sharing">Who else can access your Personal Data</h3>
<p>
...
<h3 id="lgpd-security">How we secure your data</h3>
...
<h3 id="lgpd-cookies">Cookies and other technologies we use</h3>
<p>
...
<h3 id="lgpd-contact">Contact Information</h3>
<?php if ( $hasDpo ) : ?>
	<p>
		<strong id="lgpd-dpo">Data Protection Officer</strong><br>
...
<?php if ( $hasRepresentative ) : ?>
	<p>
		<strong id="lgpd-representative">Representative Contact in the EU</strong>
...
<p>
	<strong id="lgpd-dpa">Supervisory Authority</strong><br>
	<?php if ( $dpaWebsite ) : ?>
...
<h3 id="lgpd-changes">Changes to this Privacy Policy</h3>
<p>
