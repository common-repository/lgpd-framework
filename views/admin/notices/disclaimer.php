<p>
	...
	Using The LGPD Framework does NOT guarantee compliance to LGPD.
	...
	For compliance audit or further help 
	<a href="<?= lgpd('helpers')->developerDocs() ?>">contact legal professionals</a>.
	As each business and situation is unique, you might need to modify, add or delete information in these templates.
	In addition to this, you will need audit all your processing activities for achieving compliance to LGPD.
	Compliance to LGPD is risk based ongoing process.
	We are here to get you started.
</p>
<a class="button button-primary" href="<?php echo esc_url( $acceptUrl ); ?>">I accept</a>
