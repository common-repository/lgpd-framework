...
<span for="lgpd_terms">
		...
		<?php else : ?>
			...
			?>
		<?php endif; ?><?php if( get_option( 'lgpd_consent_until_display' ) === '1' ){ ?>* for<?php } ?>
	</span>
	<?php if( get_option( 'lgpd_consent_until_display' ) === '1' ){ ?>
		<span class="lgpd-consent-until-wrap">
			<span class="dashicons dashicons-calendar-alt lgpd-consent-until-cal">
